...
const SidebarFileTree = ({
  ...
  return (
    ...
    >
      <button
        className="text-xp-text-secondary hover:bg-xp-surface-light/50 bg-xp-surface sticky top-0 z-10 flex w-full items-center px-3 py-1.5 text-[10px] font-semibold uppercase tracking-widest transition-colors"
